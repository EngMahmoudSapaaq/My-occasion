...
// Fetch chats where the admin is involved
...
if (isset($_POST['submit'])) {
    ...
    if (isset($massege) && strlen(trim($massege)) > 0) {
        $insert = mysqli_query($conn, "INSERT INTO `chats`(message, provider_id, admin_id, sender) VALUES('$massege', '$provider_id', '1', 'provider')") or die('query failed');
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>My Occasion - Chat with Admin</title>
        ...
        <div class="container chat-container" style="border: 5px solid #DCD4B6;padding: 5px;border-radius: 8px;margin-top: 50px;margin-bottom: 50px">
            ...
            <div class="chat-content">
                <div class="messages" id="chatArea">
                    <!-- Dynamically display chat messages here -->
                    <?php
                    if (!isset($message)) {
                        ...
                        if ($chats && mysqli_num_rows($chats) > 0) {
                            ...
                            // Display default message if no chats exist

...
if (isset($_POST['submit'])) {
    ...
    $ratings = mysqli_query($conn, "SELECT * FROM `ratings` WHERE user_id = '$user_id' AND service_id = '$service_id'") or die('query failed');
   
    // Validate card number (should be 16 digits)
    if (isset($ratings) && mysqli_num_rows($ratings) > 0) {
        $message[] = 'I have reviewed this service before.';
    } else {
        $insert = mysqli_query($conn, "INSERT INTO `ratings`(user_id, service_id, rating_value, review) VALUES('$user_id', '$service_id', '$stars', '$review')") or die('Query failed');

        if ($insert) {
             $message1[] = ' Evaluation completed successfully!';
...
<html lang="en">
    ...
    <div class="navbar navbar-inverse set-radius-zero">
        ...
        <div class="container content-wrapper">
            <h4 class="header-line">Rateing</h4>
                ...
                <div class="col-md-6 col-md-offset-3">
                    <div class="reservation-form">
                        ...
                        <form method="post">
                            ...
                            <!-- CVV -->
                            <div class="mb-3">
                                <label for="cvv" class="form-label">User Review</label>
                                <input type="text" name="review" class="form-control" id="cvv" placeholder="Enter your Review..." >
                            </div>
                            <br>
                            <button  type="submit" name="submit" class="btn btn-primary">Rate Now</button>
                        </form>
                    </div>
                </div>
            </div>

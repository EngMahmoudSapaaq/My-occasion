...
if (isset($_GET['provider_id'])) {
    ...
    if (isset($_POST['submit1'])) {
        ...
        $update_query = "UPDATE `service_providers` SET `reason_rejection` = '$name' WHERE `provider_id` = '$provider_id'";
...
<body>
    ...
    <div class="container" style="margin-bottom: 150px; margin-top: 50px; width: 800px;">
        <div class="row">
            <div class="col-md-12">
                <h4 class="header-line">add Reason for rejection</h4>
            </div>
        </div>

        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">add Reason for rejection</h5>
            </div>
            <form method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    
                    <div class="form-group">
                        <label for="storeName">Reason for rejection</label>
                        <input type="text" name="name" class="form-control" id="storeName" placeholder="Enter Reason for rejection" required />
                    </div>
                </div>
